...
int main(int argc, char **argv)
{
 ...
 // Planning a Cartesian Path
  ...
  //  // cartesian_target.position.z = cartesian_target.position.z+0.3;
    std::cout << "\n Please input x: ";
    std::cin >> cartesian_target.position.x;

    waypoints.push_back(cartesian_target);
  //  // cartesian_target.position.x = cartesian_target.position.x-0.2;
    std::cout << "\n Please input y: ";
    std::cin >> cartesian_target.position.y;

    waypoints.push_back(cartesian_target);

  //  // cartesian_target.position.y = cartesian_target.position.y-0.1;
    std::cout << "\n Please input z: ";
    std::cin >> cartesian_target.position.z;
